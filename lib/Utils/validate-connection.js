...
const DefaultsConstants_1 = require("../Defaults/constants")
...
const generateLoginNode = (userJid, config) => {
    ...
    const payload = {
        ...
        passive: true,      // mantener comportamiento del otro baileys
        pull: true,
        username: +user,
        device: device,
        lidDbMigrated: false
...
const configureSuccessfulPairing = (stanza, { advSecretKey, signedIdentityKey, signalIdentities }) => {
    ...
    const devicePrefix = isHostedAccount ? WA_ADV_HOSTED_ACCOUNT_SIG_PREFIX : WA_ADV_DEVICE_SIG_PREFIX
