...
const getWAUploadToServer = ({ customUploadHosts, fetchAgent, logger, options }, refreshMediaConn) => {
    return async (filePath, { mediaType, fileEncSha256B64, newsletter, timeoutMs }) => {
        ...
        // FIX: Obtener el tamaño del archivo antes de subirlo
        // Esto evita el error de "chunked encoding" que rechaza WhatsApp
            ...
            try {
                const body = await axios_1.default.post(url, fs_1.createReadStream(filePath), {
                    ...
                    headers: {
                        ...
                        'Origin': Defaults_1.DEFAULT_ORIGIN,
                        // FIX: Agregamos Content-Length explícito y un User-Agent valido
                        'Content-Length': fileStats.size,
                        'User-Agent': 'WhatsApp/2.24.13.51 A' 
                    },
