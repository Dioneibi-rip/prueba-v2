...
const getWAUploadToServer = ({ customUploadHosts, fetchAgent, logger, options }, refreshMediaConn) => {
    return async (filePath, { mediaType, fileEncSha256B64, newsletter, timeoutMs }) => {
        ...
        // SOLUCIÓN: Leemos el archivo y lo convertimos a Buffer AQUÍ MISMO.
        // Esto imita el comportamiento del segundo código que me mostraste.
        // Al ser un Buffer, Axios pone automáticamente el Content-Length correcto.
        ...
        for (const { hostname } of hosts) {
            ...
            let result
            try {
                // Enviamos fileBuffer en lugar de un stream
                const body = await axios_1.default.post(url, fileBuffer, {
                    ...options,
                    maxRedirects: 0,
                    headers: {
                        ...options.headers || {},
                        ...
                        'Origin': Defaults_1.DEFAULT_ORIGIN,
                        'User-Agent': 'WhatsApp/2.24.13.51 A' // Mantenemos el User-Agent por seguridad
                    },
